...
export class DatabaseStorage implements IStorage {
  ...
  async getServices(filters?: {
    ...
    let query = db.select({
      ...
      stop1: services.stop1,
      stop2: services.stop2,
      stop3: services.stop3,
      stop4: services.stop4,
      stop5: services.stop5,
      type: services.type,
      ...
      restanteMetodoDriver: services.restanteMetodoDriver,
      showValueOnVoucher: services.showValueOnVoucher,
      kmPrevisto: services.kmPrevisto,
      tempoEstimado: services.tempoEstimado,
